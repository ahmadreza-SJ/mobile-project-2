...
import kotlinx.android.synthetic.main.layout_developer_item.view.*
...
class DeveloperRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return DeveloperViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.layout_developer_item, parent, false)
        )
    }
